...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
// packages/googleAnalytics/lib/analytics.js                                  //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
                                                                              //
...
b.method[I]()&&(b.action=qd(a,b[kd]))}};                                      // 25
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
// packages/googleAnalytics/template.googleAnalytics.js                       //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
                                                                              //
                                                                              // 1
Template.__define__("googleAnalytics", (function() {                          // 2
  var self = this;                                                            // 3
  var template = this;                                                        // 4
  return "";                                                                  // 5
}));                                                                          // 6
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
// packages/googleAnalytics/googleAnalytics.js                                //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
                                                                              //
(function() {                                                                 // 1
    var root = this, errorLog, property, getSettings;                         // 2
                                                                              // 3
    errorLog = function(str) {                                                // 4
        return console.log("[googleAnalytics]", str);                         // 5
    };                                                                        // 6
                                                                              // 7
    property = function(pr) {                                                 // 8
        var publ = Meteor.settings.public;                                    // 9
        return publ.googleAnalytics[pr];                                      // 10
    };                                                                        // 11
                                                                              // 12
    getSettings = function(prop) {                                            // 13
        var settings = Meteor.settings;                                       // 14
        if (!settings || settings && !settings.public) {                      // 15
            errorLog("settings.json file could not be found.");               // 16
            return false;                                                     // 17
        }                                                                     // 18
        return settings.public[prop];                                         // 19
    };                                                                        // 20
                                                                              // 21
    root.googleAnalytics = function(fn) {                                     // 22
         var settings = getSettings("googleAnalytics"),                       // 23
             search = root.location.search,                                   // 24
             path = root.location.pathname + ( search ? search : "");         // 25
         if (settings) {                                                      // 26
            if (!property("id")|| !property("host")) {                        // 27
                errorLog("settings.json ID or the host could not be found."); // 28
                return;                                                       // 29
            }                                                                 // 30
                                                                              // 31
            // create id and host google.                                     // 32
            ga('create', property("id"), property("host"));                   // 33
                                                                              // 34
            // send page and title                                            // 35
            ga('send', 'pageview', {                                          // 36
                page: path,                                                   // 37
                title: document.title                                         // 38
            });                                                               // 39
         } else {                                                             // 40
            errorLog("settings.json googleAnalytics property not found.");    // 41
         }                                                                    // 42
                                                                              // 43
         // callback function(settings, path) {}                              // 44
         fn && fn(settings, path, ga);                                        // 45
    };                                                                        // 46
                                                                              // 47
    // Template rendered                                                      // 48
    Template.googleAnalytics.rendered = googleAnalytics;                      // 49
}).call(this);                                                                // 50
                                                                              // 51
////////////////////////////////////////////////////////////////////////////////
...
//# sourceMappingURL=8ba02dc2c26456dcca848bd9454fd917ecf11cca.map
